...
##### Overview
The Overview page provides a comprehensive summary of key COVID-19 metrics for Europe, including:

Total reported cases and deaths in Europe
Hospital occupancy rate
ICU occupancy rate
These metrics are visualized using intuitive charts and graphs, offering stakeholders a quick snapshot of the current COVID-19 situation in the region.

<img width="311" alt="Covid_Overview" src="https://github.com/gouravjain77/Covid-Dashboard/assets/152005778/c7483ca0-af64-48de-8228-b19e7e37e8f3">

##### Country Breakdown Page
The Country Breakdown page offers a detailed analysis of COVID-19 data for the top four affected countries.

<img width="214" alt="Covid_Country Breakdown" src="https://github.com/gouravjain77/Covid-Dashboard/assets/152005778/a4631570-822a-48e8-af12-b84f012c5e5c">

##### Testing Breakdown Page:
The Testing Breakdown page presents insights into COVID-19 testing efforts and positivity rates across different countries.

<img width="215" alt="Covid_Testing" src="https://github.com/gouravjain77/Covid-Dashboard/assets/152005778/055a1a20-f450-42ef-a93c-bfbb898a72b2">

##### Export Page
The Export page provides users with the flexibility to export raw data for further analysis or reporting purposes.

<img width="208" alt="Covid_Export" src="https://github.com/gouravjain77/Covid-Dashboard/assets/152005778/5394391b-16f3-4f4f-a8cd-41c09a77769c">

### Benefits:

Efficiency: Automation streamlines the data processing workflow, reducing manual intervention and improving efficiency.
Accuracy: Structured data processing ensures the accuracy and reliability of insights derived from the dashboard.
Interactivity: Power BI dashboard offers interactive visualizations, allowing stakeholders to explore data dynamically.
Timeliness: Scheduled triggers ensure regular updates, keeping stakeholders informed with the latest COVID-19 statistics.
Scalability: Leveraging Azure services enables scalability to handle growing volumes of data and user demands effectively.

#### This project showcases the effective utilization of Azure Data Factory and Power BI to address the challenges posed by the COVID-19 pandemic, providing stakeholders with valuable insights to navigate through these unprecedented times.
